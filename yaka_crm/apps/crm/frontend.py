...
from flask.ext.wtf.html5 import DateField, TelField, IntegerField
...
from yaka.web.forms import email, url, required
from yaka.web.forms import Chosen
from yaka.web.frontend import *
